...
const Home =()=>{
    return(
        <div className="Home">
            <h1>Welcome to the Marvel Avengers!</h1>
            <hr></hr>
            <p>
                For over half a century, Earth's mightiest heroes have fought together to protect our world from danger. The Avengers first assembled in 1963, and since then they have become some of the most iconic and beloved characters in comic book history.
